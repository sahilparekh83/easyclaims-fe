...
export default function PartnerBulkUploadPage() {
  ...
  const hasErrors = result && (result.errors.length > 0 || result.skipped.length > 0);
          ...
          <CardBody>
            <ResultGrid>
              <StatCard $color="#16a34a">
                <StatValue $color="#16a34a">{result.created.length}</StatValue>
                <StatLabel>Created</StatLabel>
              </StatCard>
              <StatCard $color="#d97706">
                <StatValue $color="#d97706">{result.skipped.length}</StatValue>
                <StatLabel>Skipped (duplicate)</StatLabel>
              </StatCard>
              <StatCard $color="#dc2626">
                <StatValue $color="#dc2626">{result.errors.length}</StatValue>
